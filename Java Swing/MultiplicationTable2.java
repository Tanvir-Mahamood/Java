...
public class MultiplicationTable2 extends JFrame {
    ...
    MultiplicationTable2()
    {
        ...
        clr.setBounds(230,290,90,50);
        clr.setBackground(Color.CYAN);
        clr.setCursor(cur);
        c.add(clr);
        sub=new JButton("Calculate");
        sub.setBounds(230,230,90,50);
    ...
    public static void main(String[] args) {
        MultiplicationTable2 fr=new MultiplicationTable2();
        fr.setVisible(true);  
